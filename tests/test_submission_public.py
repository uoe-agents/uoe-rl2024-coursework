...
def test_exercise1(rl2024_dir):
    ex1_path = os.path.join(rl2024_dir, "exercise1")
...
def test_exercise2(rl2024_dir):
    ex2_path = os.path.join(rl2024_dir, "exercise2")
...
def test_exercise3(rl2024_dir):
    ex3_path = os.path.join(rl2024_dir, "exercise3")
...
def test_exercise4(rl2024_dir):
    ex4_path = os.path.join(rl2024_dir, "exercise4")
...
def test_exercise5(rl2024_dir):
    ex5_path = os.path.join(rl2024_dir, "exercise5")

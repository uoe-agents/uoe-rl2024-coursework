...
def test_imports():
    ...
    from rl2024.exercise4.train_ddpg import RACETRACK_CONFIG as CONFIG

def test_config():
    from rl2024.exercise4.train_ddpg import RACETRACK_CONFIG
...
def test_restore_file():
    ...
    save_dir = os.path.join(save_dir, 'rl2024/exercise4')
    agent.restore("racetrack_latest.pt", dir_path=save_dir)
